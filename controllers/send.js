...
const fs = require('fs');
const { MessageMedia, List, Location, Buttons } = require('whatsapp-web.js');
...
const sendMedia = (client, number = null, fileName = null, captionMedia = null) => {
    ...
    try {
        ...
        if (fs.existsSync(file)) {
            ...
            client.sendMessage(number, media, { sendAudioAsVoice: true, caption: captionMedia });
        }
    } catch (e) {
        throw e;
    }
...
const sendMessageButton = async (client, number = null, text = null, actionButtons) => {
    ...
    setTimeout(async () => {
        ...
        console.log(`⚡⚡⚡ Enviando MessageButton....`);
